    ...
    public static void main1(String[] args) {
        ...
        for (Method m : methods) {
            ...
            for (Annotation a : annotations) {
                ...
                // check if the method annotated by annotation "reflection.person.AnnMethod"
                if (m.isAnnotationPresent(AnnMethod.class)) {
                    System.out.println("  X1: found target annotation (person.AnnMethod)");
